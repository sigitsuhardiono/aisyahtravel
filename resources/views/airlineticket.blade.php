...
@section('content')
    <div class="row page-tilte align-items-center">
        <div class="col-md-auto">
            ...
            <h1 class="weight-300 h3 title">Tiket Pesawat</h1>
            <p class="text-muted m-0 desc">Halaman transaksi tiket pesawat.</p>
        </div>
        ...
        <div class="card">
            <div class="card-header p-0">
                <ul class="nav nav-tabs active-thik nav-primary border-0" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link px-4 py-3 active rounded-0" id="home-tab" data-toggle="tab" href="#inputdata" role="tab" aria-controls="home" aria-selected="true">Input Data</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-4 py-3 rounded-0" id="profile-tab" data-toggle="tab" href="#listdata" role="tab" aria-controls="profile" aria-selected="false">Data</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade  show active" id="inputdata" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        @endif
                        <form class="needs-validation" method="POST" novalidate action="{{ URL('ticket/saveairline') }}">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-lg-12 mb-4 mb-lg-0">
                                    <div class="card ">
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <select name="airlines" class="form-control" required>
                                                        @foreach($airlines as $dtAirlines)
                                                            <option value="{{$dtAirlines->code}}">{{$dtAirlines->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="booking_code" id="booking_code" required>
                                                </div>
                                                <div class="col-md-2 mb-3">
                    ...
                    <div class="tab-pane fade" id="listdata" role="tabpanel" aria-labelledby="profile-tab">
                        <table id="datatable" class="table mb-4 responsive-table table-bordered bg-white">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="resizeable">Airline <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                                <th scope="col" class="resizeable">Route <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                                <th scope="col" class="resizeable">Date <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                                <th scope="col" class="resizeable">Book Code <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                            ...
                            <tr>
                                ...
                                <td data-label="Last Name">{{$dtTicket->airline}}</td>
                                <td data-label="Some Other">{{$dtTicket->route}}</td>
                                <td data-label="Some Other">{{$dtTicket->date_departure}}</td>
                                <td data-label="Some Other">{{$dtTicket->booking_code}}</td>
                                <td data-label="Actions" class="text-md-center dropdown dropleft">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actionDropdown">
                                        <a class="dropdown-item" href="{{ url('ticket/airline/delete') }}/{{$dtTicket->id}}">Delete Row</a>
...
@endsection
@section('pages-css')
    <link href="{{mix('css/pages/airlineticket.css')}}" rel="stylesheet">
@stop
@section('pages-js')
    <script src="{{mix('js/pages/airlineticket.js')}}"></script>
@stop
