...
@section('content')
    ...
    <div class="content">
        ...
        @endif
        <form class="needs-validation" method="POST" novalidate action="{{ URL('ticket/savekai') }}">
            {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card ">
                    <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="train" class="form-control" required>
                                        @foreach($train as $dtTrain)
                                            <option value="{{$dtTrain->name}}">{{$dtTrain->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
...
@endsection
@section('pages-css')
    <link href="{{mix('css/pages/kaiticket.css')}}" rel="stylesheet">
@stop
@section('pages-js')
    <script src="{{mix('js/pages/kaiticket.js')}}"></script>
@stop
