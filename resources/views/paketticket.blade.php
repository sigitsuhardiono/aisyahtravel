...
@section('content')
    <div class="row page-tilte align-items-center">
        <div class="col-md-auto">
            ...
            <h1 class="weight-300 h3 title">Paket</h1>
            <p class="text-muted m-0 desc">Halaman transaksi tiket pengiriman paket.</p>
        </div>
    ...
    <div class="content">
        ...
        @endif
        <form class="needs-validation" method="POST" novalidate action="{{ URL('ticket/savepaket') }}">
            {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card ">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <select name="travel" class="form-control" required>
                                        @foreach($paket as $dtPaket)
                                            <option value="{{$dtPaket->name}}">{{$dtPaket->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
...
@endsection
@section('pages-css')
    <link href="{{mix('css/pages/paketticket.css')}}" rel="stylesheet">
@stop
@section('pages-js')
    <script src="{{mix('js/pages/paketticket.js')}}"></script>
@stop
