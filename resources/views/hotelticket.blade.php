                    ...
                    <div class="tab-pane fade" id="listdata" role="tabpanel" aria-labelledby="profile-tab">
                        <table id="datatable" class="table mb-4 responsive-table table-bordered bg-white">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="resizeable">System <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                                <th scope="col" class="resizeable">Hotel <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                                <th scope="col" class="resizeable">City <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                                <th scope="col" class="resizeable">Check In <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                                <th scope="col" class="resizeable">Check Out <span class="material-icons align-text-bottom ml-1 md-18">sort</span></th>
                            ...
                            @foreach($datatable as $dtTicket)
                                <tr>
                                    ...
                                    <td data-label="Phone">{{$dtTicket->phone}}</td>
                                    <td data-label="System">{{$dtTicket->system}}</td>
                                    <td data-label="Hotel">{{$dtTicket->hotel}}</td>
                                    <td data-label="City">{{$dtTicket->city}}</td>
                                    <td data-label="Check Out">{{$dtTicket->check_in}}</td>
                                    <td data-label="Check In">{{$dtTicket->check_out}}</td>
                                    <td data-label="Actions" class="text-md-center dropdown dropleft">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actionDropdown">
                                            <a class="dropdown-item" href="{{ url('ticket/hotel/delete') }}/{{$dtTicket->id}}">Delete Row</a>
