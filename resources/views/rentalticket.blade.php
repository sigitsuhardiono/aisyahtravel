...
@section('content')
    <div class="row page-tilte align-items-center">
        <div class="col-md-auto">
            ...
            <h1 class="weight-300 h3 title">Rental</h1>
            <p class="text-muted m-0 desc">Halaman transaksi tiket rental.</p>
        </div>
    ...
    <div class="content">
        ...
        @endif
        <form class="needs-validation" method="POST" novalidate action="{{ URL('ticket/saverental') }}">
            {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card ">
                            ...
                            <div class="form-row">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <select name="travel" class="form-control" required>
                                        @foreach($rental as $dtRental)
                                            <option value="{{$dtRental->name}}">{{$dtRental->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="destination" id="detination" required>
                                </div>
                                <div class="col-md-2 mb-3">
...
@endsection
@section('pages-css')
    <link href="{{mix('css/pages/rentalticket.css')}}" rel="stylesheet">
@stop
@section('pages-js')
    <script src="{{mix('js/pages/rentalticket.js')}}"></script>
@stop
